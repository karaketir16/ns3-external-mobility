...
void test(){
    std::cout << timeSinceEpochMillisec() - Simulator::Now().GetMilliSeconds()  - start << std::endl;
    Simulator::Schedule (Seconds (1.0), &test);
}
...
main (int argc, char *argv[])
{
  ...
  AnimationInterface anim ("animation_10.xml");
  Simulator::Schedule (Seconds (1.0), &test);
